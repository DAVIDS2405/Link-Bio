...
export const initialState = {"state": {"is_hydrated": false, "router": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": ""}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}}}, "state.page__state": {"is_live": 0, "live_title": ""}, "state.update_vars_internal_state": {}, "state.on_load_internal_state": {}}
...
export const StateContexts = {
  ...
  state__page__state: createContext(null),
...
export function StateProvider({ children }) {
  ...
  const [state__page__state, dispatch_state__page__state] = useReducer(applyDelta, initialState["state.page__state"])
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "state.page__state": dispatch_state__page__state,
  ...
  return (
    ...
    <StateContexts.state__page__state.Provider value={ state__page__state }>
    ...
    </StateContexts.state__page__state.Provider>
